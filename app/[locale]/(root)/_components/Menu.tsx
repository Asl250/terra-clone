	...
	return(
		<div
			...
			<div className={'md:hidden text-lg text-gray-400 hover:text-black cursor-pointer transition duration-300'}>
				...
				<p className={'md:ml-8 text-xl max-md:text-md max-md:text-sm'}>{t('catalog')}</p>
			</div>
			...
			<div className={'text-lg text-gray-400 hover:text-black cursor-pointer transition duration-300'}>
				...
				<p className={'md:ml-8 max-md:text-sm text-xl max-md:text-md md:pr-2'}>{t('basket')}</p>
			</div>
			...
			<div className={'md:hidden text-lg text-gray-400 hover:text-black cursor-pointer transition duration-300'}>
				...
				<p className={'md:ml-8 text-xl max-md:text-md max-md:text-sm'}>{t('auth')}</p>
			</div>
		</div>
	)
}
